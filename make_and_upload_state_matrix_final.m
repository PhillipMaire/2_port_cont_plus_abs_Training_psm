...
% Alexis 9-2-14 Attempting to fix states referrals-->Doesn't
% work-->Solution--> FIND WHERE VALUES ARE FILLED
% SoloParamHandle(obj, 'RealTimeStates', 'value', struct(...
%      'bitcode', 0, ...  
%      'pretrial_pause', 0, ...  
%      'sampling_period', 0, ... 
...
%            end
           ...
           stm = [stm ;
               ...
               %onLickP  onLickP  onLickP  onLickP  sAns     pr_t+pa_t 0          0; ... % Insert the lickport % Recommend: sLPP -> sAns
