...
function [x, y] = ValvesSection(obj, action, x, y)
   ...
   switch action
    case 'init',
      ...
      % --- Water valve times
      EditParam(obj, 'LWaterValveTime', valves_properties.rwater_valve_time, x, y);  next_row(y);
      EditParam(obj, 'RWaterValveTime', valves_properties.lwater_valve_time, x, y);  next_row(y);
